		...
		//4. Make a while loop that continues looping as long as the boolean created in the previous step is true.
			...
			//   Put steps 8 - 15 in the try block.
				...
				System.out.println("The server is waiting for the client to connect");
				 ...
				 System.out.println("The client as connected");
				 DataInputStream datain= new DataInputStream(newSocket.getInputStream());
				 System.out.println(datain.readUTF());
				 DataOutputStream dataout= new DataOutputStream(newSocket.getOutputStream());
				 dataout.writeUTF("hi");
				 serverSocket.close();
				}
